...
class MainViewModel : ViewModel() {
    ...
    private fun requestHomeData() = viewModelScope.launch {
        ...
        homeData.value.recentStayList.clear()
     ...
     * 최근 본 상품 데이터 조회
     */
    fun requestRecentSeenData() = viewModelScope.launch {
        val recentStayList = listOf(
            StayData(
        ...
        if (!isRemoveRecentList) {
            homeData.value.recentStayList.clear()
            homeData.value.recentStayList.addAll(recentStayList)
        }
